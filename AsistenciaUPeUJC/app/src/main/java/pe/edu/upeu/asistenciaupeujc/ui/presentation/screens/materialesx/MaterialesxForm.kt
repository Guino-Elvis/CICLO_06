        ...
        BuildEasyForms { easyForm ->
            Column(modifier = Modifier.verticalScroll(rememberScrollState())) {
             /*   NameTextField(easyForms = easyForm, text =actividad?.nombreActividad!!,"Nomb. Actividad:", MyFormKeys.NAME )*/
                ...
                /*NameTextField(easyForms = easyForm, text =materialesx?.actividadId!!,"actividadID:", MyFormKeys.ACTIVIDADID )*/
                ...
                Row(Modifier.align(Alignment.CenterHorizontally)){
                    AccionButtonSuccess(easyForms = easyForm, "Guardar", id){
                        ...
                        person.materEntre=(lista.get(3) as EasyFormsResult.GenericStateResult<String>).value
                      ...
                      /*  person.actividadId = (lista.get(7) as EasyFormsResult.StringResult).value.toLong()*/
                        /*person.actividadId=(lista.get(7) as EasyFormsResult.StringResult).value*/
